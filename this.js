...
person.logInfo.bind(dima, "frontend", "8-999-555-55-55")(); // bind не вызывает ф-цию, а возвращает новую ф-цию, которая привязала новый контекст, поэтому нужно вызвать ()()
